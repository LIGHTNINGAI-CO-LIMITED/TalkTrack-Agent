...
- Traditional normal/jump-node large-model intent recognition 2.0 model rules, including overseas `id=62`, belong to `talktrack-master` and should not be scored as smart-Agent `llmNodeModelConfig` requirements.
- `prompt` is non-empty.
